...
void render(Game *game)
{
    ...
    r.left = 100;
    r.center =1;
    ggprint16(&r, 16, 0x00ffffff, "Requirements");


    r.bot = 428;
    r.left = 150;
    //	r.center =1;
    ggprint16(&r, 16, 0x00ffffff, "Design");

    r.bot -= 45;
    r.left += 70;
    //	r.center =1;
    ggprint16(&r, 16, 0x00ffffff, "Coding");

    r.bot -= 45;
    r.left += 50;
    //	r.center =1;
    ggprint16(&r, 16, 0x00ffffff, "Testing");

    r.bot -= 40;
    r.left += 70;
    //r.center =1;
    ggprint16(&r, 16, 0x00ffffff, "Maintenance");
}
